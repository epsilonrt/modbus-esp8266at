/*
    ModbusEsp8266AT.cpp - Source for Modbus IP ESP8266 AT Library
    Copyright (C) 2015 André Sarmento Barbosa
*/
#include "ModbusEsp8266AT.h"


ModbusEsp8266AT::ModbusEsp8266AT() {

}

void ModbusEsp8266AT::config (ESP8266 & wifi, String ssid, String password) {
  //Check errors
  //Enable serial log
...
void ModbusEsp8266AT::task() {
  ...
  if (raw_len > 7) {
    ...
    for (int i = 0; i < _len; i++) {
      _frame[i] = buffer[7 + i];  //Get Modbus PDU
    }
